<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="access-rules.ascx.cs" Inherits="ReportApp.admin.controls.access_rules" %>
                            ...
                            <td valign="top" style="padding-right: 30px; width: 150px;">
                                <div class="treeView">
                                    <asp:TreeView runat="server" ID="FolderTree" OnSelectedNodeChanged="FolderTree_SelectedNodeChanged" ExpandDepth="1" ShowLines="True">
                                        <RootNodeStyle ImageUrl="~/Images/treeview/folder-open.gif" HorizontalPadding="5" />
                                        <ParentNodeStyle ImageUrl="~/Images/treeview/folder.gif" HorizontalPadding="5" />
                                        <LeafNodeStyle ImageUrl="~/Images/treeview/folder.gif" HorizontalPadding="5" />
                                        <SelectedNodeStyle ImageUrl="~/Images/treeview/folder-open.gif" HorizontalPadding="5" CssClass="tvSelectedNodeStyle" />
                                    </asp:TreeView>
                                </div>
                            </td>
