<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="edit-user-modal.ascx.cs" Inherits="ReportApp.admin.controls.edit_user_modal" %>
...
<div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <cc1:TabContainer ID="tcntUserInfo" runat="server" ActiveTabIndex="2" 
                    ...
                    <ContentTemplate>
                        <div class="contentTemplate">
                            ...
                            <asp:DetailsView AutoGenerateRows="False" DataSourceID="MemberData" 
                                ...
                                DefaultMode="Edit" CssClass="dv" GridLines="None" 
                                onpageindexchanging="UserInfo_PageIndexChanging">
                                <Fields>
